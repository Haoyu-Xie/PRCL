# author: Haoyu Xie
# Acknowledgemet: Thanks to  https://github.com/jizongFox/Deep-Co-Training-for-Semi-Supervised-Image-Segmentation for their
#                   wonderful work. Part of the code is a reference to theirs.
